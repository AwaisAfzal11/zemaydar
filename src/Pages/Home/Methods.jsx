    ...
    <div className="py-20 bg-gray-100">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-800">The Way to Join Us</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {investmentMethods.map((method, index) => (
            <div key={index} className="bg-white p-8 rounded-lg shadow-lg border-t-4 border-[#3D498A]">
              <h3 className="text-2xl font-bold text-[#3D498A] mb-4">{method.title}</h3>
